...
from google.cloud.vmmigration_v1.services.vm_migration import VmMigrationAsyncClient
...
from google.cloud.vmmigration_v1.services.vm_migration import transports
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (VmMigrationAsyncClient, transports.VmMigrationGrpcAsyncIOTransport, "grpc_asyncio"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    ...
    (VmMigrationAsyncClient, transports.VmMigrationGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (VmMigrationClient, transports.VmMigrationGrpcTransport, "grpc", "false"),
    (VmMigrationAsyncClient, transports.VmMigrationGrpcAsyncIOTransport, "grpc_asyncio", "false"),
])
@mock.patch.object(VmMigrationClient, "DEFAULT_ENDPOINT", modify_default_endpoint(VmMigrationClient))
@mock.patch.object(VmMigrationAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(VmMigrationAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    VmMigrationClient, VmMigrationAsyncClient
])
@mock.patch.object(VmMigrationClient, "DEFAULT_ENDPOINT", modify_default_endpoint(VmMigrationClient))
@mock.patch.object(VmMigrationAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(VmMigrationAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (VmMigrationAsyncClient, transports.VmMigrationGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
])
...
def test_create_source_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_source(
            parent='parent_value',
            source=vmmigration.Source(vmware=vmmigration.VmwareSourceDetails(username='username_value')),
...
def test_delete_source(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_source),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_fetch_inventory(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.fetch_inventory),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = vmmigration.FetchInventoryResponse(
            vmware_vms=vmmigration.VmwareVmsDetails(details=[vmmigration.VmwareVmDetails(vm_id='vm_id_value')]),
        )
...
async def test_list_utilization_reports_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_utilization_reports(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_utilization_report(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_utilization_report),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_utilization_report(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_utilization_report),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_utilization_report(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_utilization_report),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
async def test_list_datacenter_connectors_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_datacenter_connectors(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_datacenter_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_datacenter_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_datacenter_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_datacenter_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_datacenter_connector_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_datacenter_connector(
            parent='parent_value',
            datacenter_connector=vmmigration.DatacenterConnector(create_time=timestamp_pb2.Timestamp(seconds=751)),
...
def test_delete_datacenter_connector(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_datacenter_connector),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_upgrade_appliance(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.upgrade_appliance),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_migrating_vm(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_migrating_vm),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_migrating_vm_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_migrating_vm(
            parent='parent_value',
            migrating_vm=vmmigration.MigratingVm(compute_engine_target_defaults=vmmigration.ComputeEngineTargetDefaults(vm_name='vm_name_value')),
...
async def test_list_migrating_vms_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_migrating_vms(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_migrating_vm(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_migrating_vm),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = vmmigration.MigratingVm(
            ...
            group='group_value',
            compute_engine_target_defaults=vmmigration.ComputeEngineTargetDefaults(vm_name='vm_name_value'),
            aws_source_vm_details=vmmigration.AwsSourceVmDetails(firmware=vmmigration.AwsSourceVmDetails.Firmware.EFI),
        )
...
def test_update_migrating_vm(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_migrating_vm),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_migrating_vm(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_migrating_vm),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_start_migration(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.start_migration),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_resume_migration(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.resume_migration),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_pause_migration(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.pause_migration),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_finalize_migration(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.finalize_migration),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_clone_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_clone_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_clone_job_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_clone_job(
            parent='parent_value',
            clone_job=vmmigration.CloneJob(compute_engine_target_details=vmmigration.ComputeEngineTargetDetails(vm_name='vm_name_value')),
...
def test_cancel_clone_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.cancel_clone_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_clone_jobs(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.list_clone_jobs),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
async def test_list_clone_jobs_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_clone_jobs(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_clone_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_clone_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = vmmigration.CloneJob(
            name='name_value',
            state=vmmigration.CloneJob.State.PENDING,
            compute_engine_target_details=vmmigration.ComputeEngineTargetDetails(vm_name='vm_name_value'),
        )
...
def test_create_cutover_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_cutover_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_cutover_job_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_cutover_job(
            parent='parent_value',
            cutover_job=vmmigration.CutoverJob(compute_engine_target_details=vmmigration.ComputeEngineTargetDetails(vm_name='vm_name_value')),
...
def test_cancel_cutover_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.cancel_cutover_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
async def test_list_cutover_jobs_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_cutover_jobs(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_cutover_job(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_cutover_job),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_add_group_migration(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.add_group_migration),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_remove_group_migration(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.remove_group_migration),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
async def test_list_target_projects_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_target_projects(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_target_project(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_target_project),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_target_project(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_target_project),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_target_project(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_target_project),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_target_project(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_target_project),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_replication_cycles_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, vmmigration.ReplicationCycle)
                   for i in results)
...
async def test_list_replication_cycles_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_replication_cycles(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_replication_cycle(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_replication_cycle),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_vm_migration_host_no_port(transport_name):
    client = VmMigrationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='vmmigration.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'vmmigration.googleapis.com:443'
...
def test_vm_migration_host_with_port(transport_name):
    client = VmMigrationClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='vmmigration.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
@pytest.mark.parametrize("transport_class", [transports.VmMigrationGrpcTransport, transports.VmMigrationGrpcAsyncIOTransport])
def test_vm_migration_transport_channel_mtls_with_client_cert_source(
    transport_class
):
